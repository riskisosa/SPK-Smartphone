...
class Alternatif extends CI_Controller
{
    ...
    public function hapus($id_alternatif = null)
    {
        if (!$id_alternatif) {
            $this->session->set_flashdata('error', 'ID Alternatif tidak valid.');
            redirect('alternatif');
        }
        ...
        if ($this->alternatif_model->delete($id_alternatif)) {
            ...
            $this->session->set_flashdata('error', 'Gagal menghapus data alternatif.');
        }
